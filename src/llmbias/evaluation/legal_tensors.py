...
# ready for ECtHRDataset.eval().

# All mappings copied from fairlex.datasets.ecthr_dataset.
# """

# import json, ast, argparse, pandas as pd, torch
...
#       • Unknown IDs skipped; if none left, sets NV and logs.
#     """
...
#     valid_ids, unknown = [], []
#     for tok in raw_ids:
#         # numeric '6' -> '6', textual 'P1-1' stays, lowercase 'nv' -> 'NV'
#         candidate = tok.upper()
...
#     if unknown:
#         print(f"[PRED row {row_idx}] skipped unknown IDs: {unknown}")
