...
def main():
    ...
    ## Another personal API key
    # api_key = "REDACTED_USE_ENVIRONMENT"

    # API key
    # api_key = "REDACTED_USE_ENVIRONMENT" ## put you api key here
