...
import pandas as pd
from llmbias.evaluation.bold_original import analyze
from llmbias.evaluation.bold import evaluate, summarize_domains
...
class OriginalBoldTests(unittest.TestCase):
    ...
    def test_original_functions_are_preserved(self):
        from llmbias.evaluation import bold_original
    ...
    def test_default_workflow_is_original(self):
        ...
        self.assertEqual(WORKFLOWS['evaluate-bold'].target,'evaluation.bold:evaluate')
        self.assertIn('conv_ai/eval.py',WORKFLOWS['evaluate-bold'].source)
        self.assertEqual(WORKFLOWS['evaluate-bold-reference'].target,'evaluation.bold_reference:evaluate')
